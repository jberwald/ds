...
function [center radius] = ForwardImage1(center, radius)
%
...
%
     ...
     increase = 250;
     [garbage,s] = unix(sprintf('Forward1Raf %2.20f %2.20f %2.20f %2.20f %2.5f %2.2i', center(1), radius(1), center(2), radius(2), increase*tstep, 16));
     while(s(1) == 'f')
          increase = increase/2;
	  [garbage,s] = unix(sprintf('Forward1Raf %2.20f %2.20f %2.20f %2.20f %2.5f %2.2i', center(1), radius(1), center(2), radius(2), increase*tstep, 16));
     end
