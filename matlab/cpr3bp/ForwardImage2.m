...
function [center radius] = ForwardImage2(xcenter, xradius, xdotcenter, xdotradius)
%
...
%
     ...
     increase = 250;
     [garbage,s] = unix(sprintf('Forward2Raf %2.20f %2.20f %2.20f %2.20f %2.5f %2.2i', xcenter, xradius, xdotcenter, xdotradius, increase*tstep, 16));
     while(s(1) == 'f')
          increase = increase/2;
	  [garbage,s] = unix(sprintf('Forward2Raf %2.20f %2.20f %2.20f %2.20f %2.5f %2.2i', xcenter, xradius, xdotcenter, xdotradius, increase*tstep, 16));
     end
