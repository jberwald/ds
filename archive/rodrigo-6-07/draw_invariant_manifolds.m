...
function [x1 y1 x2 y2 x_points y_points x_reverse y_reverse x_pointss y_pointss x_reverses y_reverses] = draw_invariant_manifolds(epsilon)
% function [x1 y1 x2 y2 x_points y_points x_reverse y_reverse x_pointss y_pointss x_reverses y_reverses] = draw_invariant_manifolds(epsilon)
%
% points = bottom
% reverse = top
% s = stable
%
% function draw_invariant_manifolds(epsilon)
%
