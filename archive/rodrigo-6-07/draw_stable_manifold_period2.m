...
plot(x_points1([1:n-2]),y_points1([1:n-2]),'g','LineWidth', 2)
hold on
plot(x_other1([1:n-2]),y_other1([1:n-2]),'g','LineWidth', 2)
hold on
plot(x_points2([1:n-2]),y_points2([1:n-2]),'g','LineWidth', 2)
hold on
plot(x_other2([1:n-2]),y_other2([1:n-2]),'g','LineWidth', 2)
hold on
...
plot(x_pointss1([1:n-2]),y_pointss1([1:n-2]),'m','LineWidth', 2)
hold on
plot(x_others1([1:n-2]),y_others1([1:n-2]),'m','LineWidth', 2)
hold on
plot(x_pointss2([1:n-2]),y_pointss2([1:n-2]),'m','LineWidth', 2)
hold on
plot(x_others2([1:n-2]),y_others2([1:n-2]),'m','LineWidth', 2)
hold on
plot(W(1,1),W(2,1),'ko')
hold on
plot(W(1,2),W(2,2),'ko')
