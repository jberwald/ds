...
plot(x_points([1:n]),y_points([1:n]),'b','LineWidth', 2)
hold on
plot(x_reverse,y_reverse,'b','LineWidth', 2)
hold on
...
plot(x_pointss([1:(n-1)]),y_pointss([1:(n-1)]),'r','LineWidth', 2)
hold on
plot(x_reverses([1:(n-1)]),y_reverses([1:(n-1)]),'r','LineWidth', 2)
hold on
